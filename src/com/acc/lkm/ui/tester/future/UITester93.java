...
// Get with time out option
// resultDepartmentFuture.get(6,TimeUnit.SECONDS)  throws the TimeOutException


// NEW=>with try catch finally
public class UITester93 {
...
//--------------------
// due to above reason finally block is used and now main thread is always terminated  
// irrespective of the fact whether exception happens or not
// as customShutDownExecutor() is executed from finally block
