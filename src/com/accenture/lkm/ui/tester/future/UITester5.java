...
//Shut Down will happen before finishing the tasks
// as time given to shutdown is less where as the tasks takes more time
public class UITester5 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//Shut Down will happen before finishing the tasks
		// as time given to complete the tasks is less
		CustomExecutorServiceUtility.customShutDownExecutor(ex, 15);
	}
}
