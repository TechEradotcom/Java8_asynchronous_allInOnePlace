package com.accenture.lkm.ui.tester.future.completeable.lambda;
...
public class UITester1002 {
	...
	/*	//First task
		...
		//Combining the tasks
		CompletionStage<String> combinedResp =	resultDepartmentFuture.thenCombineAsync(
				resultEmployeeFuture,(t,u)-> {
					System.out.println(Thread.currentThread().getName()+": ***Invoked the combine***");
					return "Department Result: "+t+", Employee REsp: "+u;
				}
		,ex)
		.exceptionally(t->"Exception Happend"+t.getMessage());
